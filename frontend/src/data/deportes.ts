...
export const deportes: DeportePageData[] = [
  ...
  },
  {
    ...
    metaDescription:
      "Tenis y Varela Open en el Club Social Varela Junior. Profesores, canchas y tenis nocturno.",
    paragraphs: [
      "Clases de tenis para todas las edades y niveles.",
      "Aprende, entrena y perfecciona tu juego con nuestro equipo de profesores especializados.",
      "Consultá disponibilidad de horarios y turnos por WhatsApp con cada profesor.",
    ],
    contactLabel: "Profesores de tenis",
    contactPhones: [
      {
        name: "Ramirez Alberto",
        phone: phoneDisplay("1163598606"),
        phoneHref: tel("1163598606"),
      },
      {
        name: "Olmedo Juan",
        phone: phoneDisplay("1158537667"),
        phoneHref: tel("1158537667"),
      },
      {
        name: "Villalba Jeronimo",
        phone: phoneDisplay("1168357403"),
        phoneHref: tel("1168357403"),
      },
      {
        name: "Forrich Leandro",
        phone: phoneDisplay("1137777749"),
        phoneHref: tel("1137777749"),
      },
    ],
    whatsappUrl: wspFromLocal("1163598606", "Hola, consulta por tenis en el CVJ"),
