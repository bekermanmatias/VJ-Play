/**
 * Global scroll animations for the entire site
 * – Scroll-reveal (fade-in + translateY)  →  data-reveal  +  data-reveal-delay="ms"
 * – Image zoom on viewport entry           →  data-zoom-in
 * – Decorative line grow                   →  data-line-grow
 * – Quote border grow                      →  data-border-grow
 * – Hero parallax                          →  data-club-hero-img
 *
 * Auto-initialises on DOMContentLoaded. Safe to call multiple times
